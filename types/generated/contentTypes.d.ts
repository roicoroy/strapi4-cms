...
export interface ApiCowLoggerCowLogger extends Schema.CollectionType {
  collectionName: 'cow_loggers';
  info: {
    description: '';
    displayName: 'cow-logger';
    pluralName: 'cow-loggers';
    singularName: 'cow-logger';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    cowName: Attribute.String;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::cow-logger.cow-logger',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::cow-logger.cow-logger': ApiCowLoggerCowLogger;
